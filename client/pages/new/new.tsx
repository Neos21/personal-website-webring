      ...
      <form className="mb-8 space-y-6" onSubmit={onSubmit}>
        ...
        {isSelf === 0 && (
          <fieldset>
            ...
            <label>
              <div><span className="font-bold">{recommenderNameDisplayName}</span> <span className="form-label-memo">(任意・{recommenderNameMaxLength}文字以内)</span></div>
            ...
            <label>
              <div><span className="font-bold">{recommenderCommentDisplayName}</span> <span className="form-label-memo">(必須・{recommenderCommentMaxLength}文字以内)</span></div>
